...
| 2026-05-30 | — | fix: 优化智能助手 System Prompt，加入强制且具体的出行建议指令，并协调工具严格回复指令与出行建议间的逻辑冲突，实现天气问答稳定输出出行建议 | Antigravity | — |
| 2026-05-30 | — | chore: 清理远程仓库中的本地配置、示例资源、未引用静态资源及汇报生成产物，并移除 README 中失效的 docs4Dev 目录说明 | Codex | — |
